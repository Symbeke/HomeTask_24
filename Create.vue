...
<div class="wrapper">
    ...
    <input v-model="description" type="text" placeholder="Description..." class="description">
        ...
        <div class="addMemberWrapper">
            <input list="usersList" v-model="selectMember" type="text" placeholder="Choose a member..." class="addMember">
...
export default{
    ...
    methods:{
        create_chat_button_handler:async function(){
            ...
            if(!this.selectMember) return alert ('please select members')
